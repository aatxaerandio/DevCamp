...
Como comentamos en el [CheckPoint 12](../module_06_git_&_github/CheckPotin_12.md/#5-qué-es-el-enrutamiento-restful), las rutas HTTP se asocian a un verbo como GET, PUT, POST o DELETE.
